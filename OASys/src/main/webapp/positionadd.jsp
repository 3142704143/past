...
<body style="background-color: #ecf0f5;">
	...
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-12">
			<!--id="container"-->
			<div class="bgc-w box">
				<form action="${pageContext.request.contextPath }/AoaPosition/Add" method="post" onsubmit="return check();">
					<!--盒子头-->
							...
							<div class="row">
								...
								<div class="col-md-6 form-group">
									<label class="control-label"><span>层级</span></label> <input
										name="level" class="form-control" value=""/>
								</div>
								<div class="col-md-6 form-group">
								...
								<div class="col-md-6 form-group">
									...
									<textarea rows="5" cols="20" name="describtion"  class="form-control" style="margin: 0px -0.5px 0px 0px; height: 114px; width: 507px;"></textarea>
								</div>
							</div>
						</div>
					</div>
