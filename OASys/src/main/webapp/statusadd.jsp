			...
			<div class="box-body no-padding">
				<div class="box-body">
						...
						<div class="col-md-6 form-group">
							...
							<input class="form-control" name="statusModel" value=""/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>状态</span></label> 
							<input class="form-control" name="statusName" value=""/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>排序值</span></label> 
							<input class="form-control" name="sortValue" value=""/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>颜色</span></label> 
							<input class="form-control" name="statusColor" value=""/>
						</div>
