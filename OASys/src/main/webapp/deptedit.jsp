...
<body style="background-color: #ecf0f5;">
	...
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-12">
			<!--id="container"-->
			<div class="bgc-w box">
				<form action="${pageContext.request.contextPath }/AoaDept/Update" method="post" onsubmit="return check();">
						...
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-6 form-group">
									...
									<input name="deptName" class="form-control" value="${ad.deptName }"/>
								</div>
								<div class="col-md-6 form-group">
									<label class="control-label"><span>电话</span></label> 
									<input name="deptTel" class="form-control" value="${ad.deptTel }"/>
								</div>
								<div class="col-md-6 form-group">
									<label class="control-label"><span>传真</span></label>
									<input name="deptFax" class="form-control" value="${ad.deptFax }" />
								</div>
								<div class="col-md-6 form-group">
									<label class="control-label"><span>邮箱</span></label> 
									<input name="email" class="form-control" value="${ad.email }"/>
								</div>
								<div class="col-md-6 form-group">
									<label class="control-label"><span>地址</span></label> 
									<input name="deptAddr" class="form-control" value="${ad.deptAddr }"/>
								</div>
							<!-- 	<div class="col-md-6 form-group">
