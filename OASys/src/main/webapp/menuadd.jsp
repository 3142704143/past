...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			...
			<form action="${pageContext.request.contextPath }/AoaSysMenu/toInsert" method="post" id="thisForm" onsubmit="return check();">
				<!--盒子身体-->
					...
					<div class="box-body">
						...
						<div class="row">
							<div class="col-md-6 form-group">
								...
								<input class="form-control" value="" name="menuName"/>
							</div>
							<div class="col-md-6 form-group">
								...
								<input class="form-control" value="glyphicon-record"  name="menuIcon"/>
							</div>
							<div class="col-md-6 form-group">
								<label class="control-label"><span>路径</span></label>
								 <input	class="form-control" value="" name="menuUrl"/>
							</div>
							<div class="col-md-6 form-group">
								<label class="control-label"><span>排序</span></label>
								 <input type="number" min="0" class="form-control" value="0" name="sortId"/>
							</div>
							<div class="col-md-6 form-group">
								...
								<c:if test="${status!=0 }">
									 <select class="form-control" name="parentId">
									 		...
									 		<c:forEach items="${list}" var="r">
										 		<option value="${r.menuId }"  ${menuId==r.menuId ? "selected":""}>${r.menuName }</option>
										 	</c:forEach>
									 </select>
								 </c:if>
								 <c:if test="${status==0 }">
									<input type="number" min="0" class="form-control" value="0"  name="parentId"/>
								</c:if>
							</div>
							<div class="col-md-6 form-group">
								<label class="control-label"><span>显示</span></label><br>
										<span class="labels"><label><input id="ck" name="isShow" value="" onclick="show();" type="checkbox"><i>✓</i></label></span>
							</div>
						</div>
				</div>
				</div>
