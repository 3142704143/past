...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			...
			<form action="${pageContext.request.contextPath }/AoaStatusList/Update" method="post" onsubmit="return check();">
			<!--盒子身体-->
			<div class="box-body no-padding">
				<div class="box-body">
						...
						<input type="hidden" name="statusId" value="${asl.statusId }">
						<div class="row">
						<div class="col-md-6 form-group">
							<label class="control-label"><span>模块名</span></label> 
							<input class="form-control" name="statusModel" value="${asl.statusModel }"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>状态</span></label> 
							<input class="form-control" name="statusName" value="${asl.statusName }"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>排序值</span></label> 
							<input class="form-control" name="SortValue" value="${asl.sortValue }"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>颜色</span></label> 
							<input class="form-control" name="statusColor" value="${asl.statusColor }"/>
						</div>
