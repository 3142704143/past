		...
		<div class="row" style="padding-top: 15px;">
			<div class="col-md-12">
				...
				<div class="bgc-w box">
					...
					<!--盒子身体-->
					<form action="${pageContext.request.contextPath }/AoaRole/update"  method="post" onsubmit="return check();">
							...
							<!--錯誤信息提示  -->
								...
								<div class="row">
									...
									<div class="col-md-6 form-group">
											...
											<input name="roleName" type="text" value="${role.roleName }" class="form-control" name="roleName"/>
											<input name="roleId" type="text" value="${role.roleId }" hidden="hidden" name="roleId"/>
											<input name="count" type="text" value="${count }" hidden="hidden"/>
										</div>
										<div class="col-md-6 form-group">
											<label>
												<span id="ctl00_cphMain_Label2">权限值</span>
											</label>
											<input name="roleValue" type="number" value="${role.roleValue }"
											style="background-color:#fff;" class="form-control" name="roleValue"/>
										</div>
