...
<form action="cst!update" method="post">
<div class="button_bar">
	...
	<button class="common_button" type="button" onclick="to('cst!queryCst?cl.lstId=${c.lstId}&a=1');">暂缓流失</button>
...
<table class="query_form_table">
	...
	<tr>
		<th>流失原因</th>
		<td colspan="3">
			<textarea name="cl.lstReason" rows="6" cols="50" required>${c.lstReason}</textarea><span class="red_star">*</span></td>
		</tr>
</table>
</form>
<br />
