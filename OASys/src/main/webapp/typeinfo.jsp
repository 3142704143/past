...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			...
			<!--盒子身体-->
			<form method="post" action="${pageContext.request.contextPath }/AoaTypeList/Update" onsubmit="return check();">
			<div class="box-body no-padding">
				...
				<div class="alert alert-danger alert-dismissable" role="alert"
					...
					<div class="row">
						<input type="hidden" value="${atl.typeId }" name="typeId">
						<div class="col-md-6 form-group">
							<label class="control-label"><span>模块名称</span></label>
							<input class="form-control" name="typeModel" value="${atl.typeModel }"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>类型</span></label>
							<input class="form-control" name="typeName" value="${atl.typeName }"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>排序值</span></label> 
							<input type="number" min="0" class="form-control" name="sortValue" value="${atl.sortValue }"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>颜色</span></label>
							<input  class="form-control" name="typeColor" value="${atl.typeColor }"/>
						</div>
				</div>
			</div>
		</div>
