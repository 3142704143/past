	...
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-12">
			...
			<div class="bgc-w box">
				...
				<!--盒子身体-->
				<form method="post" action="${pageContext.request.contextPath }/AoaTypeList/Add" onsubmit="return check();">
						...
						<div class="alert alert-danger alert-dismissable" role="alert"
							...
							<div class="row">
								<div class="col-md-6 form-group">
									...
									<input class="form-control" name="typeModel" value=""/>
								</div>
								<div class="col-md-6 form-group">
								...
								<div class="col-md-6 form-group">
									...
									<input type="number" min="0" class="form-control" name="sortValue" value=""/>
								</div>
								<div class="col-md-6 form-group">
									<label class="control-label"><span>颜色</span></label>
									<input  class="form-control" name="typeColor" value=""/>
								</div>
						</div>
					</div>
				</div>
