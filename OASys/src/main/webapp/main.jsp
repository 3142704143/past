...
<script type="text/javascript">
	function ajaxUpdateColor(color){
		$.post("AoaUser/updateColor",{"color":color},function(data){});
	}
	function funblue(Status){
		console.log("点击变蓝了");
		if(Status==2){
			ajaxUpdateColor("blue");
		}
		parent.toblue();
		toblue();
	}
	function fungreen(Status){
		console.log("点击变绿了");
		if(Status==2){
			ajaxUpdateColor("green");
		}
		parent.togreen();
		togreen();
	}
	function funyellow(Status){
		console.log("点击变黄了");
		if(Status==2){
			ajaxUpdateColor("yellow");
		}
		parent.toyellow();
		toyellow();
	}
	function funred(Status){
		console.log("点击变红了");
		if(Status==2){
			ajaxUpdateColor("red");
		}
...
<div class="head-show" style="position: relative; height: 76px;">
	<h3 style="display: inline-block; float: left;margin-left: 16px;">控制面板
		<div style="display: inline-block;margin-left: 20px;">
			<span class="thiscolor toblue" style="background-color:#00c0ef" onclick="funblue(2);"></span> 
			<span class="thiscolor togreen" style="background-color:#00a65a" onclick="fungreen(2);"></span> 
			<span class="thiscolor toyellow" style="background-color:#f39c12" onclick="funyellow(2);"></span> 
			<span class="thiscolor tored" style="background-color:#dd4b39" onclick="funred(2);"></span>
		</div>
	</h3>
...
<div class="jichu kaoqin " style="cursor: pointer;">
	...
	<a href="${pageContext.request.contextPath}/AoaAttendsList/queryById/1" class="moreduo"> 更多 <span
	...
	$(".attendce").on('click',function(){
		...
		<div class="col-md-3">
			<div class="jichu filecolor">
				...
				<a href="filemanage.html" class="moreduo"> 更多 <span
					class="glyphicon glyphicon-circle-arrow-right"></span>
				</a>
			</div>
		</div>
		...
		<div class="col-md-3">
			<div class="jichu tongxun">
				...
				<a href="addrmanage.html" class="moreduo"> 更多 <span
					class="glyphicon glyphicon-circle-arrow-right"></span>
				</a>
			</div>
		</div>
		...
		<div class="col-md-3">
			<div class="jichu chat">
				...
				<a href="chatlist.html" class="moreduo"> 更多 <span
					class="glyphicon glyphicon-circle-arrow-right"></span>
				</a>
			</div>
		</div>
					...
					<div class="pull-right right-btn-group dropdown"
						...
						<div style="display: inline-block;">
							...
							<ul class="dropdown-menu">
								<li><a href="morelog.html">历史记录</a></li>
							</ul>
						</div>
				...
				<div class="panel-heading box-show-heading"
					...
					<div class="pull-right right-btn-group dropdown"
						...
						<div style="display: inline-block;">
							...
							<ul class="dropdown-menu">
								<li><a href="informmanage.html">公告通知</a></li>
							</ul>
						</div>
						<a  ><button>
								<span class="glyphicon glyphicon-minus shousuo"></span>
				...
				<div id="" class="shrink">
					<table class="table table-hover" >
						<tr>
							...
							<tr>
								<td>总经办</td>
								<td>2017-9-21 12:39:13</td>
								<td><span class="label label-danger">紧急</span></td>
								<td><span>fdsafsa</span></td>
								<td><a href="informshow.html?id=4&read=1&relationid=15" class="look-xiangxi"><span
										class="glyphicon glyphicon-search"> </span> 查看 </a></td>
							</tr>
							<tr>
								<td>总经办</td>
								<td>2017-8-21 12:39:07</td>
								<td><span class="label label-primary">一般</span></td>
								<td><span>fsa </span></td>
								<td><a href="informshow.html?id=3&read=1&relationid=14" class="look-xiangxi"><span
										class="glyphicon glyphicon-search"> </span> 查看 </a></td>
							</tr>
							<tr>
								<td>总经办</td>
								<td>2019-1-13 0:27:27</td>
								<td><span class="label label-warning">重要</span></td>
								<td><span>您有一个日程即将开始</span></td>
								<td><a href="informshow.html?id=40&read=0&relationid=168" class="look-xiangxi"><span
										class="glyphicon glyphicon-search"> </span> 查看 </a></td>
							</tr>
							<tr>
								<td>总经办</td>
								<td>2017-9-18 12:39:18</td>
								<td><span class="label label-primary">一般</span></td>
								<td><span>what？？</span></td>
								<td><a href="informshow.html?id=5&read=1&relationid=16" class="look-xiangxi"><span
										class="glyphicon glyphicon-search"> </span> 查看 </a></td>
							</tr>
				...
				<div class="panel-heading box-show-heading"
					...
					<div class="pull-right right-btn-group dropdown"
						...
						<div style="display: inline-block;">
							...
							<ul class="dropdown-menu">
								<li><a href="procedure.html">新建流程</a></li>
								<li><a href="flowmanage.html">流程管理</a></li>
							</ul>
						</div>
						<a  ><button>
								<span class="glyphicon glyphicon-minus shousuo"></span>
					...
					<table class="table table-hover" >
						<tr>
							...
							<tr>
								...
								<td><a href="serch.html"  class="look-xiangxi"><span
										class="glyphicon glyphicon-search"> </span> 查看 </a></td>
							</tr>
					</table>
				</div>
				...
				<div class="panel-heading box-show-heading"
					...
					<div class="pull-right right-btn-group dropdown"
						...
						<div style="display: inline-block;">
							...
							<ul class="dropdown-menu">
								<li><a href="planmanage.html">计划管理</a></li>
								<li><a href="planadd.html">新增计划</a></li>
							</ul>
						</div>
						<a  ><button>
								<span class="glyphicon glyphicon-minus shousuo"></span>
					...
					<table class="table table-hover" >
						<tr>
							...
							<tr>
								...
								<td>2019-1-11 10:42:13</td>
								<td>
								<span class="label label-success">已完成</span>
								</td>
								
								
								<td><span>完成报表1-日计划</span></td>
								<td><a href="planedit.html?pid=56" class="look-xiangxi"><span
										class="glyphicon glyphicon-search"> </span> 查看 </a></td>
							</tr>
							<tr>
								<td>
								...
								<td>2017-10-27 10:19:46</td>
								<td>
								<span class="label label-success">已完成</span>
								</td>
								
								
								<td><span>仅仅代表着</span></td>
								<td><a href="planedit.html?pid=35" class="look-xiangxi"><span
										class="glyphicon glyphicon-search"> </span> 查看 </a></td>
							</tr>
					</table>
				</div>
				...
				<div class="" style="border-bottom: 1px solid #94d294;;">
					...
					<div class="pull-right right-btn-group btn-color dropdown"
						...
						<div style="display: inline-block;">
							...
							<ul class="dropdown-menu">
								<li><a href="daymanage.html">日程管理</a></li>
								<li><a href="daycalendar.html">我的日历</a></li>
							</ul>
						</div>
				...
				<div class="panel-heading box-show-heading"
					...
					<div class="pull-right right-btn-group btn-color dropdown"
						...
						<div style="display: inline-block;">
							...
							<ul class="dropdown-menu">
								<li><a href="userpanel.html">我的便签</a></li>
							</ul>
						</div>
						<a  ><button style="background: #18e89d !important;">
								<span class="glyphicon glyphicon-minus shousuo"></span>
				...
				<div  class="shrink">
					<ul class="list-group">
						<li class="list-group-item list-group-item-li" style=""><img
							src="${pageContext.request.contextPath}/images//647cbde6-3fba-4d8c-a50f-1a07f9bee417.jpg" alt="photo" title="wowoowo"
							class="item-li-img" />
							<p class="item-li-p">
								<a href="userpanel.html">无标题 <small class="pull-right"
									style="color: #777;"><span
										class="glyphicon glyphicon-time"></span>2019-1-14 8:19:22</small>
								</a><br> 给客户打电话
							</p></li>
						<li class="list-group-item list-group-item-li" style=""><img
							src="${pageContext.request.contextPath}//images//647cbde6-3fba-4d8c-a50f-1a07f9bee417.jpg" alt="photo" title="wowoowo"
							class="item-li-img" />
							<p class="item-li-p">
								<a href="userpanel.html">确认需求 <small class="pull-right"
									style="color: #777;"><span
										class="glyphicon glyphicon-time"></span>2019-1-14 1:38:34</small>
								</a><br> 找小李确认需求
							</p></li>
						<li class="list-group-item list-group-item-li" style=""><img
							src="${pageContext.request.contextPath}//images//647cbde6-3fba-4d8c-a50f-1a07f9bee417.jpg" alt="photo" title="wowoowo"
							...
							<p class="item-li-p">
								<a href="userpanel.html">无标题 <small class="pull-right"
									style="color: #777;"><span
										class="glyphicon glyphicon-time"></span>2017-10-22 0:34:40</small>
								</a><br> 我们不一样
							</p></li>
						<li class="list-group-item list-group-item-li" style=""><img
							src="${pageContext.request.contextPath}//images//647cbde6-3fba-4d8c-a50f-1a07f9bee417.jpg" alt="photo" title="wowoowo"
							...
							<p class="item-li-p">
								<a href="userpanel.html">无标题 <small class="pull-right"
									style="color: #777;"><span
										class="glyphicon glyphicon-time"></span>2017-10-22 0:34:38</small>
								</a><br> 我们不一样
							</p></li>
						<li class="list-group-item list-group-item-li" style=""><img
							src="${pageContext.request.contextPath}//images//647cbde6-3fba-4d8c-a50f-1a07f9bee417.jpg" alt="photo" title="wowoowo"
							...
							<p class="item-li-p">
								<a href="userpanel.html">无标题 <small class="pull-right"
									style="color: #777;"><span
										class="glyphicon glyphicon-time"></span>2017-10-22 0:34:37</small>
								</a><br> 我们不一样
							</p></li>
					</ul>
...
<script src="${pageContext.request.contextPath}/js/littlecalendar.js"></script>
<script src="${pageContext.request.contextPath}/js/highcharts/jquery.js"></script>
<script src="${pageContext.request.contextPath}/js/highcharts/highcharts.js"></script>
<script src="${pageContext.request.contextPath}/js/tongji.js"></script>
