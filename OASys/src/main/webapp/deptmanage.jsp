	...
	<div class="col-md-12">
		...
		<div class="bgc-w box box-primary">
			...
			<div class="box-header">
				<h3 class="box-title">
					<a href="${pageContext.request.contextPath }/deptadd.jsp" class="label label-success" style="padding: 5px;">
					...
					<table class="table table-hover table-striped">
						...
						<c:forEach items="${list }" var="v">
							<tr>
								...
								<td><span>${v.deptTel }</span></td>
								<td><span>${v.email }</span></td>
								<td><span>${v.deptAddr }</span></td>
								<td>
									<a href="${pageContext.request.contextPath }/AoaDept/toUpdate?id=${v.deptId}" class="label xiugai">
									<span class="glyphicon glyphicon-edit"></span> 修改</a> 
									<a href="${pageContext.request.contextPath }/AoaDept/toPersonnolTransfer?id=${v.deptId}" class="label xiugai">
										<span class="glyphicon glyphicon-search"></span> 人事调动
									</a>
									<a onclick="{return confirm('删除该记录将不能恢复，确定删除吗？');};" href="${pageContext.request.contextPath }/AoaDept/Delete?id=${v.deptId}" class="label shanchu"><span
